import { useState, useCallback } from 'react'; // Removido useEffect
...
  }, [user, dateRangeFn]);
  ...
  // --- CORREÇÃO AQUI ---
  // Trocamos o useEffect pelo useFocusEffect da forma correta
  useFocusEffect(
    useCallback(() => {
      fetchTasks(); // Chamamos a função async aqui dentro
    }, [fetchTasks]) // A dependência é o fetchTasks que já está com useCallback
  );

  // ... (o resto do seu hook permanece exatamente igual) ...

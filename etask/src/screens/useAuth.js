...
export const useAuth = () => {
  ...
  const [msRequest, msResponse, msPromptAsync] = AuthSession.useAuthRequest(
    {
      clientId: 'SEU_CLIENT_ID_MICROSOFT', // Substitua pelo seu Client ID da Microsoft
      scopes: ['openid', 'profile', 'email'],
      redirectUri: AuthSession.makeRedirectUri({ useProxy: true }), // Garanta que o proxy seja usado para Expo Go
    },
    microsoftDiscovery
  );
